...
- [ 斯透奇斯规则(Sturges'rule)](#head14)
- [ 数据分箱之pd.cut()](#head15)
- [ reshape新生成数组和原数组公用一个内存，不管改变哪个都会互相影响。](#head16)
- [ 交叉验证详解](#head17)
- [ 交叉验证如何取K值？](#head18)
- [ 方差、协方差、标准差、均方差、均方根值、均方误差、均方根误差对比分析](#head19)
- [kaggle提供的tesla V100支持to_fp16](#head20)
- [ 混合精度训练](#head21)
...
# <span id="head20">kaggle提供的tesla V100支持to_fp16</span>
...
https://blog.csdn.net/sufubo/article/details/50990684  
